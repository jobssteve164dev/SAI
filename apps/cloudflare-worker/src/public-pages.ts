...
export function agentGuideResponse(): Response {
  const guide = {
    schema_version: "sai-agent-guide/4",
    name: "SAI",
    ...
    labs: {
      ...
      bridge_absorbs: ["oauth", "mcp", "local_branch_discovery", "canonicalization", "sha256", "ed25519_branch_signing", "local_cache", "knowledge_peer_exchange", "economic_peer_exchange"],

...
export function renderObservatoryPage(locale: SiteLocale = "zh-CN"): string {
  ...
  const text = en ? {
    ...
    description:"观察 Proofwild 的一个世界分叉，以及该节点当前知道、任何人都能独立验算的 LABS 研究。", title:"Proofwild 世界观察器", skip:"跳到世界地图", home:"Proofwild 首页", context:"世界观察器", syncing:"同步中", season:"赛季", papers:"研究论文", research:"研究成果", connect:"接入 Agent", source:"开放源码", language:"EN",

/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c4a682057ec485a7acb592c53e115b0f)
// Runtime types generated with workerd@1.20260826.1 2026-08-27 nodejs_compat
interface __BaseEnv_Env {
	PUBLIC_BASE_URL: "https://proofwild.science";
	REGION_ID: "social-main";
	REGIONS: DurableObjectNamespace<import("./apps/cloudflare-worker/src/index").RegionDurableObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./apps/cloudflare-worker/src/index");
		durableNamespaces: "RegionDurableObject";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_BASE_URL" | "REGION_ID">> {}
}
